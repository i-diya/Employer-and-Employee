  ...
  if(isset($_POST['username']) && isset($_POST['password']))
  {
    ...
    $result2 = $conn->query($query2);
        ...
        $row2 = mysqli_fetch_array($result2);
               ...
               if($row2['password'] = $password){echo "<html><h3>Logged in as ".$row['name']."</h3></html>" ; }
                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li><a href="show_candidates.php">Browse Candidates</a></li>
                          <li><a href="new-post.php">Post a Job</a></li>
                          <li><a href="search_by_custom.php">Employeer Profile</a></li>
  ...
  if(isset($_POST['username']) && isset($_POST['password']))
  {
    ...
    $result2 = $conn->query($query2);
        ...
        $row2 = mysqli_fetch_array($result2);
               ...
               while($row = mysqli_fetch_array($result1))
  if($row2['password'] = $password){echo "<html><h5 >".$row['description']."</h3></html>" ; }
...
?> 
              ...
              <div class="col-md-6">
                <h3 class="footer-heading mb-4 text-white">Quick Menu</h3>
                  <ul class="list-unstyled">
                    <li><a href="#">No. of candidates for each job</a></li>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy; <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> All Rights Reserved | This template is made with <i class="icon-heart text-warning" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >DBMS</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
